...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    } flex items-center justify-center h-[700px] transition-[flex] duration ease-out-flex cursor-pointer`}
  ...
  >
    ...
    />
    {active !== id ? (
      <h3 className='font-semibold sm:text-[26px] text-[18px] text-grey absolute z-0 
